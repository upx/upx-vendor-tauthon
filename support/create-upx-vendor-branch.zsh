...
[[ -d $tmpdir ]] || exit 1
cp -ai --parents LICENSE Include Modules Objects Parser Python $tmpdir
...
rm **/*.txt
rm Modules/_ctypes/libffi/texinfo.tex
rm Modules/zlib/zlib.map
rm Modules/Setup.dist
rm Modules/cstubs
rm Modules/ld_so_aix.in
rm Modules/ld_so_beos
rm Modules/makesetup
rm Modules/makexp_aix
rm Parser/Python.asdl
rm -r Modules/_ctypes
rm -r Modules/_sqlite
rm -r Modules/zlib
